...
plt.yscale('log')
plt.title('I-V analysis', fontsize=16, fontweight='bold')
...
plt.ylabel('Transmission[dB]', fontsize=13)
plt.title('Transmission spectra as measured', fontsize=16, fontweight='bold')
...
plt.xlabel('Wavelength[nm]', fontsize=13)
plt.ylabel('Transmission[dB]', fontsize=13)
plt.title('Transmission spectra as measured\n(Fitting)', fontsize=18, fontweight='bold')
plt.legend(loc='best', ncol=2, fontsize=10)
plt.tight_layout()
